...
# dodana tabela s³ownika
# weight waga slowa
# status - 0 wulgaryzmy (stala baza nie moze byc edytowana), 1 slowa zdefiniowane przez admina
# active_word - 1 aktywne 0 nieaktywne


CREATE TABLE {$db_prefix}dictionary_admin (
  id_word mediumint(8) unsigned NOT NULL auto_increment,
  word varchar(255) NOT NULL default '',
  weight int,
  word_status tinyint(4),
  active_word tinyint(4), 
  PRIMARY KEY (id_word),
) ENGINE=MyISAM;
...
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('chój',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('chóje',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('chuje',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('cipa',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('cipka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('cipke',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('dziwka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('hóje',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('hójowe',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('huj',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('huje',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('hujnia',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('hujowe',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('hujowe',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('kórwa',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('kurewka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('kurwa',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('pierdole',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('pizda',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('pizdê',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('pizd¹',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('przejebane',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('przejebie',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('rozjebaæ',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('rozjebie',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('rozpierdala',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('rozpierdole',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('ruchacz',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('ruchaæ',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('ruchaæ',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('spierdala',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zajebac',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zajebaæ',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zajeba³',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zajebany',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zajebie',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zapierdala',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zapierdole',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zjebaæ',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zjebanego',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zjebany',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zjebany',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('zjebka',10, 0, 1);
