...
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Antylak',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Atłasowiec',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Bagiennik',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Bekardy',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Bekas',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Bernikla',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Białozór',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Biegus',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Bielik',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Birginiak',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Błękitnik',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Błotniak',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Błyskotek',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Borowiak',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Brzegówka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Brzytwodziób',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Chronka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Cieciornik',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Cynamonka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Cytrynka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Czapla',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Czeczotka',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Czubacz',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Dławigad',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Drozd',10, 0, 1);
insert into {$db_prefix}dictionary_admin(word, weight, word_status, active_word) values('Dzięcioł',10, 0, 1);
